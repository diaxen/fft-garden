           ...
           int s, int log2_N)
{
  ...
  switch (l)
    ...
    default:
      ...
      for (unsigned k = 1; k < l / 4; k++)
        {
          complex double t = get_twiddle(k << s, log2_N);

          ct_dit_bf2(l, out + k, t);
          ct_dit_bf2(l, out + k + l / 2, t * -I);
          ct_dit_bf2(l, out + l / 2 - k, conj(t * I));
          ct_dit_bf2(l, out + l - k, conj(-t));
        }
    }
}
